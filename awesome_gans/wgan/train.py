...
results = {'output': './gen_img/', 'model': './model/WGAN-model.ckpt'}
...
def main():
    ...
    ds_iter = DataIterator(
        x=iu.transform(ds.train_images, '127'), y=ds.train_labels, batch_size=train_step['batch_size'], label_off=True
    ...
    with tf.Session(config=config) as s:
        # WGAN Model
        model = wgan.WGAN(
            s, batch_size=train_step['batch_size'], height=32, width=32, channel=3, enable_gp=True
        )  # WGAN-GP
